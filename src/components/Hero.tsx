    ...
    <section className="bg-primary">
      <div className="container mx-auto pt-[69px] grid grid-cols-1 md:grid-cols-2 pb-10 md:pb-0">
        <div className="flex flex-col items-center md:items-start justify-center pt-10 ">
          ...
          <h1 className="text-center md:text-left font-secondary text-5xl mt-5 mb-10">
            I Build & Design <br />
            Web Interfaces
          </h1>
          ...
          <button className="bg-accent px-4 py-2 mt-5 hover:bg-accent-hover">Work with me</button>
        </div>
